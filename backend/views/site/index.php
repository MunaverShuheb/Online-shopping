...
<div style="width:100%;height: 100%;position: relative;">
    ...
    <div class="col-md-3" style="margin: 3%;">
        <?= Html::beginForm(['/site/addproducts'], 'post')
                        . Html::submitButton(
                            '<span>'.' Add Product',
                            ['class' => 'btn  btn-lg','style' =>  'background:#242348; color:#fff;']
                        )
                        . Html::endForm() ?></span>
    </div>

    <div class="col-md-10 text-right" style=""><br>
        <?=
        Html::beginForm(['/site/index'], 'post') ?>
<div class="col-md-9"> </div>
  <div class="input-group col-md-3">  
    ...
    <div class="col-md-10" style=""> 
      ...
      'id' => 'myTable',
      'columns' => [
                   ['class' => 'yii\grid\SerialColumn'],'p_name','details','price',

...
<?php endif; ?>
    ...
    <?php echo $form->field($model, 'p_name')->textInput()->input('p_name', ['placeholder' => "Product name"])->label(false); ?><br>

    <?php echo $form->field($model, 'details')->textInput()->input('details', ['placeholder' => "Enter Details"])->label(false); ?><br>

    <?php echo $form->field($model, 'price')->textInput()->input('price', ['placeholder' => "Enter Price"])->label(false); ?><br>
